...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        punc = list(" !@#$%^&*()-_+={}[]|\:;'<>?,./\"")
        dict = {}
        #for every index and its character in vowels permutation string
        for i, let in enumerate(vowels_permutation.lower()):
            #assign key containing current character to value containing 
            #corresponding index of VOWELS string
